...
import { Avatar, ButtonGroup, Divider, IconButton, Paper,Menu, MenuItem, Snackbar } from '@material-ui/core';
...
export default function PostCard(props) {
  ...
  return (
    <Paper elevation={3} className="d-flex flex-column p-2 mx-2 my-4">
      ...
      id='video-post'
      src={props.img}
      style={{objectFit:'cover',height:"95vw",width:'100%'}}
      />
      </div>
      <ButtonGroup className='mt-2' color="default">
        ...
        <IconButton onClick={handleSnack}>
          <Share />
          <Snackbar style={{bottom:120}} open={open} autoHideDuration={2000} onClose={handleSnackClose}>
